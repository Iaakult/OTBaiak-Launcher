...
export function Profiles():Promise<Array<main.LaunchProfile>>;

export function Revision():Promise<number>;

export function SelectProfile(arg1:string):Promise<boolean>;

export function SelectedProfile():Promise<string>;
